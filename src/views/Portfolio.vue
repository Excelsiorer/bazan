                ...
                <ul class="instalations__menu">
                    ...
                    <li>
                        <ul class="menu">
                            ...
                            <li>
                                <router-link to="/contacts " class="menu__el"
                                    >contacts
                                </router-link>
                            </li>
                        </ul>
                ...
                >
                    ...
                    >
                        ...
                        <div class="instalations__works">
                            <router-link
                                v-for="(project, projectKey) in projectType"
                                :key="projectKey"
                                class="work col-24"
                            ...
                            >
                                ...
                                <div class="work__body">
                                    <header class="instalations__header">
                                        ...
                                        <p class="work__description col-12">
                                            {{ project.description }}
                                        </p>
                                    </header>

                                    <footer class="work__footer">
                                        <div class="work__language">
                                            {{ project.language }}
                                        </div>
    ...
    methods: {
        setActiveMenu(event, currentItem, lastActiveItem) {
            ...
            this.fixedPositionX = currentItem
                ...
                : 0;
            let hash = currentItem ? currentItem.hash.split("-") : [0, 0];
